...
public class AuthController {
    ...
    public ResponseEntity<Void> register(@Valid @RequestBody RegisterRequestDTO registerRequestDTO) throws UsernameExistsException {
        ...
        kafkaMessagesSenderAPI.sendMessage(KafkaMessagesTopics.REGISTER_USER, new RegisterSuccessfulEmailData(registerRequestDTO.email(), registerRequestDTO.username()));
